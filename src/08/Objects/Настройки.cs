...
namespace IIS.08
{
    ...
    public class Настройки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.08.ТипНастр fТипНастроек;
        ...
        public virtual IIS.08.ТипНастр ТипНастроек
        {
            get
            {
                ...
                IIS.08.ТипНастр result = this.fТипНастроек;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.08.Сервер.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НастройкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НастройкиE", typeof(IIS.08.Настройки));
                }
            }
        }
    }
    ...
    public class DetailArrayOfНастройки : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.08.DetailArrayOfНастройки members)

        // *** End programmer edit section *** (IIS.08.DetailArrayOfНастройки members)
        ...
        /// </summary>
        public DetailArrayOfНастройки(IIS.08.Сервер fСервер) : 
                base(typeof(Настройки), ((ICSSoft.STORMNET.DataObject)(fСервер)))
        {
        }
        
        public IIS.08.Настройки this[int index]
        {
            get
            {
                return ((IIS.08.Настройки)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.08.Настройки dataobject)
        {
